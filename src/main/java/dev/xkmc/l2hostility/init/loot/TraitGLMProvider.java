...
public class TraitGLMProvider extends GlobalLootModifierProvider {
	...
	protected void start() {
		...
		add(LHTraits.SPEEDY.get(), loot3, new ItemStack(LCItems.CAPTURED_WIND.get(), 1), 3, 0, 0.1, 100);
		...
		add(LHTraits.LEVITATION.get(), loot2, new ItemStack(LCItems.CAPTURED_BULLET.get(), 1), 1, 0, 0.1);
		...
		add(LHTraits.SOUL_BURNER.get(), loot2, new ItemStack(LCItems.SOUL_FLAME.get(), 2), 1, 0, 0.1);
		add(LHTraits.FREEZING.get(), loot2, new ItemStack(LCItems.HARD_ICE.get(), 2), 1, 0, 0.1);
		...
		add(LHTraits.CURSED.get(), loot2, new ItemStack(LCItems.CURSED_DROPLET.get(), 1), 3, 0, 0.05);
		add(LHTraits.CORROSION.get(), loot2, new ItemStack(LCItems.CURSED_DROPLET.get(), 1), 1, 0, 0.1);
		add(LHTraits.EROSION.get(), loot2, new ItemStack(LCItems.CURSED_DROPLET.get(), 1), 1, 0, 0.1);
		add(LHTraits.KILLER_AURA.get(), loot4, new ItemStack(LCItems.EMERALD.get(), 1), 1, 0, 0.02);
		add(LHTraits.RAGNAROK.get(), loot4, new ItemStack(LCMats.ETERNIUM.getNugget(), 4), 1, 0, 0.1);
		add(LHTraits.SHULKER.get(), loot2, new ItemStack(LCItems.CAPTURED_BULLET.get(), 1), 1, 0, 0.2);
		add(LHTraits.GRENADE.get(), loot3, new ItemStack(LCItems.STORM_CORE.get(), 1), 3, 0, 0.1);
		...
		add(LHTraits.DRAIN.get(), loot2, new ItemStack(LHItems.WITCH_DROPLET.get(), 1), 1, 0, 0.1);
		add(LHTraits.GROWTH.get(), loot2, new ItemStack(Items.ENCHANTED_GOLDEN_APPLE, 1), 1, 0, 0.02);
		add(LHTraits.SPLIT.get(), loot2, new ItemStack(LCItems.GUARDIAN_EYE.get(), 1), 1, 0, 0.05);
		...
		add(LHTraits.STRIKE.get(), loot2, new ItemStack(LCItems.EXPLOSION_SHARD.get(), 1), 1, 0, 0.1);
		add(LHTraits.PULLING.get(), loot3, new ItemStack(LCItems.BLACKSTONE_CORE.get(), 1), 1, 0, 0.05);
