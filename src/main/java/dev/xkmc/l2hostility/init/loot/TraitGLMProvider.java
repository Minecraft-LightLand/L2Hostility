...
public class TraitGLMProvider extends GlobalLootModifierProvider {
	...
	protected void start() {
		...
		add(LHTraits.CURSED.get(), loot2, new ItemStack(LCItems.CURSED_DROPLET, 1), 2, 0, 0.05);
		add(LHTraits.CORROSION.get(), loot2, new ItemStack(LCItems.CURSED_DROPLET, 1), 1, 0, 0.2);
		add(LHTraits.EROSION.get(), loot2, new ItemStack(LCItems.CURSED_DROPLET, 1), 1, 0, 0.2);
