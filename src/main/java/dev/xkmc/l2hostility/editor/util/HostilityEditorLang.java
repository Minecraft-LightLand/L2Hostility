...
public enum HostilityEditorLang {
	...
	TAG_INFO_BLACKLIST("editor.tag_info_blacklist", "Entities in this tag never receive levels or traits.", 0, ChatFormatting.GRAY),
	TAG_INFO_WHITELIST("editor.tag_info_whitelist", "Entities in this tag can receive levels. Required for entities that don't have levels by default.", 0, ChatFormatting.GRAY),
	TAG_INFO_DEFAULT_BLACKLIST("editor.tag_info_default_blacklist", "Default entity blacklist for traits. Entities here are excluded from trait rolls.", 0, ChatFormatting.GRAY),
	TAG_INFO_DEFAULT_WHITELIST("editor.tag_info_default_whitelist", "Default entity whitelist for traits. Entities here are preferred trait targets.", 0, ChatFormatting.GRAY),
	TAG_INFO_NO_SCALING("editor.tag_info_no_scaling", "Entities in this tag never get level-based stat scaling.", 0, ChatFormatting.GRAY),
	TAG_INFO_NO_TRAIT("editor.tag_info_no_trait", "Entities in this tag never receive traits.", 0, ChatFormatting.GRAY),
	TAG_INFO_SEMIBOSS("editor.tag_info_semiboss", "Boss-like entities that will be excluded from some traits with special mechanics.", 0, ChatFormatting.GRAY),
	TAG_INFO_EFFECT_IMMUNE("editor.tag_info_effect_immune", "Entities that seem to be immune to effects and thus should not get traits that can only be countered by effects.", 0, ChatFormatting.GRAY),
	TAG_INFO_NO_DROP("editor.tag_info_no_drop", "Entities in this tag drop no hostility loot.", 0, ChatFormatting.GRAY),
	TAG_INFO_HIDE_TRAITS("editor.tag_info_hide_traits", "Hide the trait display above these entities.", 0, ChatFormatting.GRAY),
	TAG_INFO_HIDE_LEVEL("editor.tag_info_hide_level", "Hide the level display above these entities.", 0, ChatFormatting.GRAY),
	TAG_INFO_HIDE_TITLE("editor.tag_info_hide_title", "Hide both level and trait display.", 0, ChatFormatting.GRAY),
	TAG_INFO_ARMOR_TARGET("editor.tag_info_armor_target", "Entities in this tag can be equipped with armor by hostility.", 0, ChatFormatting.GRAY),
	TAG_INFO_MELEE_WEAPON_TARGET("editor.tag_info_melee_weapon_target", "Entities in this tag can hold melee weapons.", 0, ChatFormatting.GRAY),
	TAG_INFO_RANGED_WEAPON_TARGET("editor.tag_info_ranged_weapon_target", "Entities in this tag can hold bows/crossbows.", 0, ChatFormatting.GRAY),
	TAG_INFO_SPAWNER_BLACKLIST("editor.tag_info_hostility_spawner_blacklist", "Entities in this tag cannot be spawned by the hostility spawner.", 0, ChatFormatting.GRAY),

	// Short names of the managed tag files (shown as the file row label in the Tags tab)
	TAG_NAME_BLACKLIST("editor.tag_blacklist", "Blacklist", 0, null),
	TAG_NAME_WHITELIST("editor.tag_whitelist", "Whitelist", 0, null),
	TAG_NAME_DEFAULT_BLACKLIST("editor.tag_default_blacklist", "Default Blacklist", 0, null),
	TAG_NAME_DEFAULT_WHITELIST("editor.tag_default_whitelist", "Default Whitelist", 0, null),
	TAG_NAME_NO_SCALING("editor.tag_no_scaling", "No Scaling", 0, null),
	TAG_NAME_NO_TRAIT("editor.tag_no_trait", "No Traits", 0, null),
	TAG_NAME_SEMIBOSS("editor.tag_semiboss", "Semi-Boss", 0, null),
	TAG_NAME_EFFECT_IMMUNE("editor.tag_effect_immune", "Effect Immune", 0, null),
	TAG_NAME_NO_DROP("editor.tag_no_drop", "No Loot", 0, null),
	TAG_NAME_HIDE_TRAITS("editor.tag_hide_traits", "Hide Traits", 0, null),
	TAG_NAME_HIDE_LEVEL("editor.tag_hide_level", "Hide Level", 0, null),
	TAG_NAME_HIDE_TITLE("editor.tag_hide_title", "Hide Title", 0, null),
	TAG_NAME_ARMOR_TARGET("editor.tag_armor_target", "Armor Targets", 0, null),
	TAG_NAME_MELEE_WEAPON_TARGET("editor.tag_melee_weapon_target", "Melee Weapon Targets", 0, null),
	TAG_NAME_RANGED_WEAPON_TARGET("editor.tag_ranged_weapon_target", "Ranged Weapon Targets", 0, null),
	TAG_NAME_SPAWNER_BLACKLIST("editor.tag_hostility_spawner_blacklist", "Spawner Blacklist", 0, null),
