...
public enum HostilityEditorLang {
	...
	RANK_MIN_TIP("editor.tip_rank_min", "Ranks this preset trait is always scaled up to, even if the mob level would not afford them.", 0, ChatFormatting.GRAY),
	...
	SLOT_TIP("editor.tip_slot", "Equipment slot of the items: mainhand, offhand, head, chest, legs or feet.", 0, ChatFormatting.GRAY),
	ITEM_LEVEL_TIP("editor.tip_item_level", "Mob level at which this pool of items can be dropped.", 0, ChatFormatting.GRAY),
	ITEM_CHANCE_TIP("editor.tip_item_chance", "Chance that one item from this pool is dropped.", 0, ChatFormatting.GRAY),

	ENTITY_MIN_TIP("editor.tip_entity_min", "Minimum level a mob of this type can spawn with.", 0, ChatFormatting.GRAY),
	...
	MAX_COUNT_TIP("editor.tip_max_count", "Maximum number of this minion type a master can keep alive at the same time.", 0, ChatFormatting.GRAY),
	MINION_MIN_TIP("editor.tip_minion_min", "Minimum level the minions are spawned with.", 0, ChatFormatting.GRAY),
	MINION_HP_TIP("editor.tip_minion_hp", "Max health of each minion, as a percentage of the master's max health.", 0, ChatFormatting.GRAY),
	SPAWN_RANGE_TIP("editor.tip_spawn_range", "Radius around the master (in blocks) where minions are spawned.", 0, ChatFormatting.GRAY),
	SPAWN_INTERVAL_TIP("editor.tip_spawn_interval", "Time between spawning attempts for minions, in ticks.", 0, ChatFormatting.GRAY),
	COOLDOWN_TIP("editor.tip_cooldown", "Time, in ticks, between two minions of this type can spawn.", 0, ChatFormatting.GRAY),
	COPY_LEVEL_TIP("editor.tip_copy_level", "Minions spawn at the same level as the master when on.", 0, ChatFormatting.GRAY),
	COPY_TRAIT_TIP("editor.tip_copy_trait", "Minions copy the master's traits when on.", 0, ChatFormatting.GRAY),
	LINK_DISTANCE_TIP("editor.tip_link_distance", "Max distance from the master (in blocks) before the minion is disconnected and discarded.", 0, ChatFormatting.GRAY),
	PROTECT_MASTER_TIP("editor.tip_protect_master", "Minions attack entities that attack their master.", 0, ChatFormatting.GRAY),
	DISCARD_UNLINK_TIP("editor.tip_discard_unlink", "Minions vanish as soon as the link distance is exceeded.", 0, ChatFormatting.GRAY),
	MASTER_MAX_TOTAL_TIP("editor.tip_master_max_total", "Highest total number of minions this master keeps alive.", 0, ChatFormatting.GRAY),
	MASTER_SPAWN_INTERVAL_TIP("editor.tip_master_spawn_interval", "Delay between minion spawn kept by the master, in ticks.", 0, ChatFormatting.GRAY),
