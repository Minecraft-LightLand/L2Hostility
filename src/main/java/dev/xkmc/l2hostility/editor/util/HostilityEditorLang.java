...
public enum HostilityEditorLang {
	...
	TAG_INFO_WHITELIST("editor.tag_info_whitelist", "Entities in this tag always receive traits when eligible.", 0, ChatFormatting.GRAY),
	...
	TAG_INFO_SEMIBOSS("editor.tag_info_semiboss", "Mini-boss entities, treated as stronger mobs by hostility scaling.", 0, ChatFormatting.GRAY),
	TAG_INFO_EFFECT_IMMUNE("editor.tag_info_effect_immune", "Entities in this tag are immune to trait-applied effects.", 0, ChatFormatting.GRAY),
	...
	TAG_INFO_HIDE_TITLE("editor.tag_info_hide_title", "Hide the boss title for these entities.", 0, ChatFormatting.GRAY),
